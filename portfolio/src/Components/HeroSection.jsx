...
export default function HeroSection() {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-1/2 space-y-8">
            <div className="inline-block">
              <span className="bg-gray-800 bg-opacity-80 text-orange-400 px-4 py-2 rounded-full text-sm font-medium border border-orange-400 border-opacity-30 shadow-lg">
                {/* Typed text element */}
                <span
                  ref={typedTextRef}
                  id="typed-text"
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              <span className="text-orange-400 relative">
                digital experiences
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-orange-400 bg-opacity-30 rounded-full"></span>
              </span>{" "}
              that make an impact
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button className="bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-6 rounded-lg transition-all flex items-center gap-2 shadow-lg">
                View My Work
                <ArrowRight size={18} />
              </button>
              <button className="bg-gray-800 hover:bg-gray-700 text-orange-400 border border-orange-400 border-opacity-30 font-medium py-3 px-6 rounded-lg transition-all shadow-lg">
                Get In Touch
              </button>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 relative">
            {/* Social media icons - vertical floating bar with enhanced styling */}
            ...
            {/* Removed animated 3D decoration elements */}

            {/* Enhanced stylish image with frame effect using only Tailwind */}
            <div className="group relative z-10 w-4/5 mx-auto aspect-square">
              {/* Frame border */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-400 via-purple-500 to-blue-500 p-1 shadow-2xl transition-transform">
                <div className="absolute inset-0 rounded-2xl overflow-hidden opacity-30"></div>
              </div>

              {/* Profile image container */}
              <div className="relative z-10 rounded-2xl overflow-hidden w-full h-full shadow-2xl transform transition-transform duration-300 group-hover:scale-105">
            ...
            <div className="flex md:hidden justify-center mt-8 gap-6">
              <a
                href="#"
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white opacity-60 flex flex-col items-center">
