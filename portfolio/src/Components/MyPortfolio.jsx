  ...
  const portfolioData = [
    {
      ...
      title: "EventLanka",
      description:
        "A full-stack MERN application built to streamline event organization and online ticket booking for Sri Lankan events.",
      image: "/img/EventLanka.png",
      link: "View Project",
      url: "https://github.com/MininduBimsara/EventLanka.git",
      category: "Full Stack",
      technologies: [
        "React",
        "Node.js",
    ...
    },
    {
      ...
      title: "FuelWiseLK",
      description:
        "A fuel quota management system designed for Sri Lanka to streamline fuel distribution during crises.",
      image: "/img/Home_Page.png",
      link: "View Project",
      url: "https://github.com/MininduBimsara/FuelWiseLK.git",
      category: "Full Stack",
      technologies: ["React", "Java", "Spring Boot", "MySQL", "Tailwind CSS"],
    },
    {
      id: 3,
      title: "SwiftConnect",
